    ...
    <Adminlayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="container">
  <p class="container-title">Dashboard<br></p>

  <div class="gradient-cards">
    <div class="card">
      <div class="container-card bg-green-box">
        <img src="/images/svg/users.svg"  style="height: 100px">
        <p class="card-title">{{ counts }}</p>
        <p class="card-description">"Your journey is your own, and every step you take is a unique piece of your story. Embrace the path ahead, for it's the twists and turns that make your adventure truly beautiful."</p>
      </div>
    </div>
...
.container-card {
  ...
  background: linear-gradient(71deg, #201c22, #1a171c, #080509);
