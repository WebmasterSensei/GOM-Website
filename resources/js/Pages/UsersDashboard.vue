    ...
    <UserLayout>
        <section class="background-radial-gradient overflow-hidden">
                ...
                <div class="flex w-full flex-wrap items-center justify-between px-3" style="width: 80%; margin: auto; ">            
                    ...
                    <div class="!visible hidden flex-grow basis-[100%] items-center lg:!flex lg:basis-auto"
                        ...
                        <a class="mb-4 ml-2 mr-5 mt-3 flex items-center text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:mb-0 lg:mt-0"
                            href="#">
                            <img src="/images/logo/gmpng.png" style="height: 40px" alt="TE Logo" loading="lazy" />
                        </a>
                    ...
                    <div class="relative flex items-center" v-if="$page.props.auth.user && roles.includes('admin')">
                        ...
                        <div class="relative" data-te-dropdown-ref data-te-dropdown-alignment="end">
                            ...
                            <a :href="route('admin.dashboard')" type="button" data-te-ripple-init
                                data-te-ripple-color="light" class="inline-block rounded mx-2 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal 
              text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out
               ...
               dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]
                dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]">
                    ...
                    <div class="relative flex items-center" v-if="$page.props.auth.user && roles.includes('user')">
            ...
            <div class="px-6 py-20 text-center md:px-5 lg:py-39 lg:text-left">
                ...
                <div class="w-100 mx-auto text-neutral-800 sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">
                    <p class="mb-10 text-left" style="font-size: 21px; color: rgb(202, 202, 202);">
                        {{ greetings }}
                    </p>
                    <div class="grid items-center gap-12 lg:grid-cols-2">
                        <div class="mt-12 lg:mt-0" style="z-index: 10">
                            ...
                            <span
                                class="mt-0 mb-12 text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl text-yellow text-[hsl(218,81%,75%)] animate__animated animate__fadeInUp animate__slow">Ministries</span>
                            ...
                            <p class="opacity-70 text-[hsl(218,81%,85%)] animate__animated animate__zoomIn animate__slow mt-4"
        ...
        <section class="px-6 py-16 text-center md:px-12 lg:py-16 lg:text-left container-app" ref="revealContainer">
            <div class="md:container  reveal mx-auto p-4">
                <!-- <a href="https://kennyjey1321.web.app">CLick</a> -->
        ...
        <section class="lg:text-left container-app" ref="revealContainer2">
            <div class="md:container reveal mx-auto">
                ...
                <div class="reveal" v-for="prev in prevEvent" :key="prev.id"
                    style="border: solid rgb(196, 196, 196) 1px; border-radius: 10px; margin-bottom: 5px;">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-1">
                        <div style="border-right: solid rgb(196, 196, 196) 1px; padding: 20px;">
                            <div class="overflow-y-auto" style="height: 330px;">
                                <div class="relative overflow-hidden bg-cover bg-no-repeat" v-for="img in prev.image"
                                    :key="img">
                                    <img class="w-full"
                                        style="height: 100%; box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;"
                                        :src="'/images/events/' + img" alt="" />
                                </div>
                            </div>
                            <small v-if="prev.image" class="flex justify-center animate-pulse mt-2">note: scroll this image
                                down to see more photos...</small>
                        ...
                        <div class="p-4" style="margin-bottom: 5px; padding: 30px; border-radius: 5px;">
                            <div style="display: flex; justify-content: space-between;">
                                <h2 class="mb-0 animate-pulse" style="font-size: 20px; font-weight: 600;">{{ prev.title }}
                                </h2>
                            ...
                            <div class="flex justify-center mb-4 mt-2">
                                <h2 style="font-size: 18px; font-weight: 500; color: rgb(31, 31, 31); letter-spacing: 1px;">
                                    {{ prev.theme }}</h2>
                            </div>
                            <div class="flex justify-center mb-2 mt-2">
                                <h2 style="font-size: 17px; font-weight: 500; color: rgb(55, 55, 55); letter-spacing: 1px;">
                                    {{ prev.verse_chapter }}</h2>
                            </div>
                            <div class="w-full">
                                {{ prev.desc }}
                            </div>
                ...
                <nav aria-label="Page navigation example" class="mt-10 mb-5 flex justify-center">
                    <ul class="list-style-none flex space-x-2">
                        <li v-for="page in pagination.links" :key="page.label">
                            <a v-if="page.url" href="#" @click.prevent="fetchData(page.url)" class="relative block rounded bg-transparent px-3 py-1.5 text-sm transition-all duration-300 
                ...
                <div
                    style="border: 1px solid rgb(199, 199, 199) ; padding: 10px ;border: none; border-radius: 10px ; background: #f5f9fd">
                    <div class="flex justify-center">
                        ...
                        <div class="mb-12 flex">
                            ...
                            <div class="ml-4 grow">
                                <div class="" style="display: flex; justify-content: space-between">
                                    ...
                                    <p class="mb-1" style="font-weight: 600; color: rgb(139, 139, 139); font-size: 15px">{{
                                        formattedDate(newEve.date) }}</p>
                                </div>
                ...
                <nav aria-label="Page navigation example" class="mt-10 mb-2 flex justify-center">
                    <ul class="list-style-none flex space-x-2">
                        <li v-for="page in paginationNew.links" :key="page.label">
                            <a v-if="page.url" href="#" @click.prevent="fetchNewData(page.url)" class="relative block rounded bg-transparent px-3 py-1.5 text-sm transition-all duration-300 
                              dark:text-black dark:hover:bg-neutral-700 dark:hover:text-black"
                                :class="{ 'text-neutral-600 hover:bg-neutral-100': !page.active, 'font-bold bg-neutral-100': page.active }"
                                v-html="page.label"></a>
                            <span v-else class="relative block rounded bg-transparent px-3 py-1.5 text-sm
                        ...
                        <nav aria-label="Page navigation example" class="mt-10 mb-2 flex justify-center">
                            <ul class="list-style-none flex space-x-2">
                                <li v-for="page in paginationYt.links" :key="page.label">
                                    <a v-if="page.url" href="#" @click.prevent="fetchYtLinks(page.url)" class="relative block rounded bg-transparent px-3 py-1.5 text-sm transition-all duration-300 
                                                dark:text-black dark:hover:bg-neutral-700 dark:hover:text-black"
                                        :class="{ 'text-neutral-600 hover:bg-neutral-100': !page.active, 'font-bold bg-neutral-100': page.active }"
                                        v-html="page.label"></a>
                                    <span v-else class="relative block rounded bg-transparent px-3 py-1.5 text-sm
...
.typewriter-text {
    ...
    margin: 0 auto;
    letter-spacing: .15em;
    /* Adjust letter spacing for a cleaner look */
